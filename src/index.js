...
let strNumberLength=strNumber.length;
    ...
    if (strNumberLength===2&&number<100) {
      if(number%10==0) {
       ...
       else message.push(NUMBERS[(Math.floor(number/10))*10], NUMBERS[number%10])
       return message.join(" ");
    }
    if (strNumberLength===3&&number<1000) {
      if (number%100<10) {
        if (number%100==0) {
          ...
          return message.join(" ");
        } else message.push(NUMBERS[(Math.floor(number/100))], NUMBERS[100], NUMBERS[number%100])
        return message.join(" ");
      }
      if ((number%100)<20) {
      ...
      if (20<(number%100)<100){
        ...
        return message.join(" ");
        } else message.push(NUMBERS[(Math.floor(number/100))], NUMBERS[100], NUMBERS[(Math.floor((number%100)/10))*10], NUMBERS[number%10])
        return message.join(" ");
      }
    }
  }
